...
class ZZCutFlowHists_efficiency(ZZHistSaver):
    def __init__(self, fileName, channels, *args, **kwargs):
        ...
        super(ZZCutFlowHists_efficiency, self).__init__(fileName, channels, *args, **kwargs)
    ...
    def setupTemplate(self):
        ...
        etaFlow = {c : EtaVarDict for c in cutList}
