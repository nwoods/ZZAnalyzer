...
class HZZ4lDREt2FSRCleaner(ZZRowCleanerBase):
    def __init__(self, channel, cutter):
        super(HZZ4lDREt2FSRCleaner, self).__init__(channel, cutter)
    ...
    def isNewBest(self, row, newEvent):
        ...
        dZ = zCompatibility(row, objects[0], objects[1], fsrType='DREt2FSR')
