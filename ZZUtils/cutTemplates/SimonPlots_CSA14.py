...
Cutter for the CSA14 SMP ZZ analysis, inherits most methods from Cutter.py
...
class SimonPlots_CSA14(Cutter.Cutter):
    def __init__(self):
        super(SimonPlots_CSA14, self).__init__("SimonPlots_CSA14")
    ...
    def getCutTemplate(self,*args):
        ...
        cutTemplate = {
            ...
            'eIso' : { 
                'cuts' : { 'RelPFIsoRhoCSA14' : (0.4, True) },
                'logic' : 'and',
                'objects' : '1',
                'type' : 'base',
            },
            'eTightIso' : { 
                'cuts' : { 'RelPFIsoRhoCSA14' : (0.2, True) },
                'logic' : 'and',
                'objects' : '1',
                'type' : 'base',
            },
    ...
    def setupCutFlow(self):
        ...
        flow['Z1SIP'] = ('ZSIP', [1,2])
        flow['Z2SIP'] = ('ZSIP', [3,4])
        flow['CrossClean'] = ('CrossClean', [1,2,3,4])
        flow['Z1Cand'] = ('GoodZCand', [1,2])
        flow['Z2Cand'] = ('GoodZCand', [3,4])
        flow['Z1Iso'] = ('ZIso', [1,2])
        flow['Z2Iso'] = ('ZIso', [3,4])
