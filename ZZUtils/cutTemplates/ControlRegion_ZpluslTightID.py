...
class ControlRegion_ZpluslTightID(ControlRegion_Base):
    def __init__(self, cutset="ControlRegion_ZpluslTightID"):
        super(ControlRegion_ZpluslTightID, self).__init__(cutset)
    ...
    def setupCutFlow(self):
        ...
        '''
        superFlow = super(ControlRegion_ZpluslTightID, self).setupCutFlow()
