...
#             },
            ...
            'eMVAID' : {
                'cuts' : {
                    ...
                    'etaLow' : 0.8,
                    'etaHigh' : 1.479,
                    'lowPtLowEta' : (-0.586, False),
                    'lowPtMedEta' : (-0.712, False),
                    'lowPtHighEta' : (-0.662, False),
                    'highPtLowEta' : (-0.652, False),
                    'highPtMedEta' : (-0.701, False),
                    'highPtHighEta' : (-0.350, False),
                },
                'objects' : '1',
                'logic' : 'other',
            },
