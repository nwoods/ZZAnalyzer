...
class ControlRegion_ZpluslIso(ControlRegion_Base):
    def __init__(self, cutset="ControlRegion_ZpluslIso"):
        super(ControlRegion_ZpluslIso, self).__init__(cutset)
    ...
    def setupCutFlow(self):
        ...
        '''
        superFlow = super(ControlRegion_ZpluslIso, self).setupCutFlow()
