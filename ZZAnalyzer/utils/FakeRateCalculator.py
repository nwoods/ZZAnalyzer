...
from ZZAnalyzer.utils.helpers import parseChannels, mapObjects
...
if __name__ == '__main__':
    ...
    parser = ArgumentParser(description="Running FakeRateCalculator "
    ...
    calc = FakeRateCalculator(filesDataLoose, filesDataTight,
