...
Inherits from HistSaver, which inherits from ResultSaver
...
from ZZAnalyzer.results import HistSaver
from ZZAnalyzer.utils.helpers import evVar, Z_MASS



class ZZFinalHists(HistSaver):
