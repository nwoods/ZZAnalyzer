...
Base cutter for the 2016 ZZ analyses
...
#             },
            ...
            'eMVAID' : {
                ...
                'objects' : '1',
                'logic' : 'other',
                'branches' : ['e[1-4]?MVANonTrigID', 'e[1-4]?Pt', 'e[1-4]?SCEta'],
            },
            'eTightID' : {
                'cuts' : {
                    'ZZTightIDNoVtx' : (1, ">="),
        ...
        temp = super(BaseCuts2016, self).getCutTemplate(*args)

        temp.update(cutTemplate)
    ...
    def setupOtherCuts(self):
        ...
        others = super(BaseCuts2016, self).setupOtherCuts()
