...
Plotter for ZZ->4l analysis for the old output files that stored histograms.
...
if __name__ == "__main__":
    ...
    plotter = PlotFromHists(channels, args.intlumi, args.outdir, args.infiles)
